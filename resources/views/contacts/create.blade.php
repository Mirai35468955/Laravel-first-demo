                    ...
                    <div class="container px-5 mx-auto">
                        ...
                        <div class="lg:w-1/2 md:w-2/3 mx-auto">
                            ...
                            <div class="relative">
                                ...
                                <input type="text" id="email" name="email" value="{{ old('emali') }}" class="w-full bg-gray-100 bg-opacity-50 rounded border border-gray-300 focus:border-indigo-500 focus:bg-white focus:ring-2 focus:ring-indigo-200 text-base outline-none text-gray-700 py-1 px-3 leading-8 transition-colors duration-200 ease-in-out">
                            </div>
                            </div>
